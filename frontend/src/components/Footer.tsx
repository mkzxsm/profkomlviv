...
const Footer: React.FC = () => {
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/pposlnu",
      icon: SiFacebook,
      color: "group-hover:bg-blue-600",
    },
    {
      name: "Instagram",
      href: "https://instagram.com/profkom_lnu",
      icon: SiInstagram,
      color: "group-hover:bg-blue-600",
    },
    {
      name: "YouTube",
      href: "https://www.youtube.com/channel/UC-q4zCHeNdLGN9XV166LPkw",
      icon: SiYoutube,
      color: "group-hover:bg-blue-600",
    },
    {
      name: "Telegram",
      href: "https://t.me/profkom_lnu",
      icon: SiTelegram,
      color: "group-hover:bg-blue-600",
    },
    {
      name: "TikTok",
      href: "https://tiktok.com/@profkom_lnu",
      icon: SiTiktok,
      color: "group-hover:bg-blue-600",
    },
    {
      name: "Linktree",
      href: "https://linktr.ee/profkom_lnu?fbclid=PAZXh0bgNhZW0CMTEAAae26D-DnoPLqxjtnCE6zvdowWD2_ASv2tcuDnfqkkuJtmJnKcLi-ecf_W-YTQ_aem_jBGPBwPhE8bONl0wqVDWdg",
      icon: SiLinktree,
      color: "group-hover:bg-blue-600",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="lg:col-span-1 flex">
              <div
                className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 flex-1 flex flex-col justify-center transform transition-transform duration-500 ease-in-out
              ...
              >
                ...
                <p className="text-gray-300 leading-relaxed text-sm">
                  Первинна профспілкова організація студентів Львівського
                  національного університету ім. Івана Франка працює з 1957 року
                  🫶 Студентська Профспілка — неприбуткова громадська
                  організація, яка працює над створенням можливостей усебічного
                  поступу, захистом прав та представництвом інтересів студентів
                  та аспірантів, які є членами Профспілки 💙
                </p>
              </div>
            </div>
            ...
            {/* Contact Information */}
            <div className="lg:col-span-1 flex">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 flex-1 flex flex-col justify-center transform transition-transform duration-500 ease-in-out hover:-translate-y-2 hover:shadow-lg">
                <h3 className="text-xl font-bold mb-6 text-blue-600">
                ...
                <div className="grid xs:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-4 text-sm">
                  <div className="group">
                    ...
                    >
                      ...
                      <div className="text-gray-300 group-hover:text-blue-600 transition-colors block">
                        м. Львів
                        <br />
        ...
        <div className="bg-transparent">
          ...
          >
            ...
            <p className="hidden text-gray-300 text-sm text-center sm:text-left sm:block">
              © {new Date().getFullYear()} ППОС ЛНУ ім. Івана Франка. Всі права
              захищені. Розробники: Юрій Мазур, Богуслав Мазурик
            </p>
            ...
            <p className="text-gray-300 text-sm text-center sm:hidden">
              © {new Date().getFullYear()} Профком студентів ЛНУ імені Івана
              Франка. Всі права захищені.
            </p>
          </div>
        </div>
      </div>
