  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 bg-white/75 backdrop-blur-xl border-b border-white/50 shadow-[0_4px_30px_rgba(0,0,0,0.05)] transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center h-14 md:h-16">
            ...
            <Link
              to="/"
              className="flex items-center space-x-2.5 group rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
            >
              <img
                src="/logo.png"
              ...
              {navigation.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`relative px-3.5 py-1.5 rounded-xl text-sm font-semibold transition-all duration-300 ease-out border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2
                      ${
                        active
            ...
            <div className="lg:hidden flex items-center">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-xl text-slate-700 bg-white/50 border border-white/50 hover:bg-white/80 backdrop-blur-md transition-all duration-300 shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
              >
      ...
      <div
        ...
        {...(!isMenuOpen ? { inert: "" } : {})}
      >
        <nav aria-label="Мобільна навігація" className="px-4 py-3 space-y-1.5">
          {navigation.map((item) => {
            const active = isActive(item.href);
            return (
              <Link
                ...
                className={`block px-5 py-3 rounded-xl text-sm font-semibold transition-all duration-300 border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 ${
                  active
